        ...
        <Col xl={6}>
          <div className="about-target-text">
            ...
            <p className="esubtitle" style={{ textAlign: 'left' }}>
              ...
              специалистов для узбекских и международных IT-компаний.
              А также помощь начинающим IT-специалистам в поиске первого рабочего места в индустрии.
              Лучшие слушатели курсов будут рекоммендованны к прохождению стажировки в
              нашей команде Endpoint.
            </p>
          </div>
        </Col>
      </Row>
